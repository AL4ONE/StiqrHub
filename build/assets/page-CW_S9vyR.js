...
`).map(a=>`  ${a}`).join(`
`);function xt(){const[e,a]=M.useState(null),[i,r]=M.useState(void 0),o=(l,n,s)=>{r(s.id),a(n)};return t.jsx(w,{title:"OnSeriesItemClick Chart",codeModel:t.jsx(Ct,{}),children:t.jsxs(Q,{direction:{xs:"column",md:"row"},alignItems:{xs:"flex-start",md:"center"},justifyContent:"space-between",sx:{width:"100%"},children:[t.jsx(ce,{component:"pre",sx:{maxWidth:{xs:"100%",md:"50%",flexShrink:1},overflow:"auto"},children:`item id: ${i??"undefined"}

                   item identifier:
                   ${At(e)}`}),t.jsx(S,{series:[{data:bt}],onItemClick:o,width:400,height:200,margin:{right:200}})]})})}const ft=[{to:"/",title:"Home"},{title:"PieCharts"}],pa=()=>t.jsxs(ne,{title:"PieCharts",description:"this is PieCharts ",children:[t.jsx(le,{title:"PieCharts",items:ft}),t.jsxs(G,{container:!0,spacing:3,children:[t.jsx(G,{size:{md:6},children:t.jsx(Xe,{})}),t.jsx(G,{size:{md:6},children:t.jsx(Ye,{})}),t.jsx(G,{size:{md:6},children:t.jsx(qe,{})}),t.jsx(G,{size:{md:6},children:t.jsx(at,{})}),t.jsx(G,{size:{md:6},children:t.jsx(nt,{})}),t.jsx(G,{size:{md:6},children:t.jsx(gt,{})}),t.jsx(G,{size:{md:6},children:t.jsx(dt,{})}),t.jsx(G,{size:{md:6},children:t.jsx(xt,{})})]})]});export{pa as default};
