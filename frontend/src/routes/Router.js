...
const Router = [
  {
    ...
    element: <FullLayout />,
    children: [
      { index: true, element: <Navigate to="/app/eo/dashboard" replace /> },
      ...
      { path: 'tenant/events/:id/claim', element: <ProtectedRoute><TenantClaimForm /></ProtectedRoute> },
      { path: 'tenant/events/active', element: <ProtectedRoute><TenantActiveEvents /></ProtectedRoute> },
      { path: 'tenant/claims', element: <ProtectedRoute><TenantClaimsList /></ProtectedRoute> },
      ...
      { path: 'insurer/claims', element: <ProtectedRoute><InsurerClaimsInbox /></ProtectedRoute> },
      { path: 'insurer/stats', element: <ProtectedRoute><InsurerStatistics /></ProtectedRoute> },
      // Proteksi dashboard dan aplikasi
      { path: 'dashboards/modern', element: <ProtectedRoute><ModernDash /></ProtectedRoute> },
      { path: 'dashboards/ecommerce', element: <ProtectedRoute><EcommerceDash /></ProtectedRoute> },
