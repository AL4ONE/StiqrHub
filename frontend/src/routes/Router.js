...
const EODashboard = Loadable(lazy(() => import('../views/dashboard/EODashboard')));
...
const InsurerDashboard = Loadable(lazy(() => import('../views/dashboard/InsurerDashboard')));
...
const InsurerStatistics = Loadable(lazy(() => import('../views/insurer/Statistics')));
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/eo/events/create', exact: true, element: <ProtectedRoute><EOCreateEvent /></ProtectedRoute> },
      { path: '/eo/events/:id', exact: true, element: <ProtectedRoute><EOEventDetail /></ProtectedRoute> },
      { path: '/eo/events/:id/rules', exact: true, element: <ProtectedRoute><EOEventRules /></ProtectedRoute> },
      { path: '/eo/payouts', exact: true, element: <ProtectedRoute><EOPayouts /></ProtectedRoute> },
      ...
      { path: '/admin/payments', exact: true, element: <ProtectedRoute><AdminPayments /></ProtectedRoute> },
      { path: '/admin/eos', exact: true, element: <ProtectedRoute><AdminVerifyEOs /></ProtectedRoute> },
      { path: '/admin/events', exact: true, element: <ProtectedRoute><AdminEventAudit /></ProtectedRoute> },
      { path: '/admin/fraud', exact: true, element: <ProtectedRoute><AdminFraud /></ProtectedRoute> },
      { path: '/admin/payouts', exact: true, element: <ProtectedRoute><AdminPayouts /></ProtectedRoute> },
      { path: '/admin/analytics', exact: true, element: <ProtectedRoute><AdminAnalytics /></ProtectedRoute> },
