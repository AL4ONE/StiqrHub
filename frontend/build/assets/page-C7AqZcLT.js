...
title: 'StraightAnglePieChart ',
  ...
  `})}function qe(){const e=[{label:"Group A",value:400,color:"#5D87FF"},{label:"Group B",value:300,color:"#0074BA"},{label:"Group C",value:300,color:"#01C0C8"},{label:"Group D",value:200,color:"#CCDA4E"},{label:"Group E",value:278,color:"#FB9678"},{label:"Group F",value:189,color:"#49BEFF"}];return t.jsx(w,{title:"StraightAngle Chart",codeModel:t.jsx(Ze,{}),children:t.jsx(S,{series:[{startAngle:-90,endAngle:90,data:e}],height:300})})}function Qe(){return t.jsx(k,{children:`
import * as React from 'react';
import { PieChart } from '@mui/x-charts/PieChart';
...
export default function PieChartWithPaddingAngleChart() {
    return (
            ...
            `})}const N=[{label:"Group A",value:400,color:"#5D87FF"},{label:"Group B",value:300,color:"#FA896B"},{label:"Group C",value:300,color:"#FFCD56"},{label:"Group D",value:200,color:"#95CFD5"}];function dt(){return t.jsx(w,{title:"PaddingAngle Chart",codeModel:t.jsx(st,{}),children:t.jsxs(Q,{direction:"row",children:[t.jsx(S,{series:[{paddingAngle:5,innerRadius:60,outerRadius:80,data:N}],margin:{right:5},width:200,height:200,legend:{hidden:!0}}),t.jsx(S,{series:[{startAngle:-90,endAngle:90,paddingAngle:5,innerRadius:60,outerRadius:80,data:N}],margin:{right:5},width:200,height:200,slotProps:{legend:{hidden:!0}}})]})})}function ct(){return t.jsx(k,{children:`
import * as React from 'react';
import { PieChart } from '@mui/x-charts/PieChart';
...
export default function PieChartWithCenterLabelChart() {
  return (
          ...
          <PieChart series={[{ data, innerRadius: 80 }]} {...size}>
            ...
            `})}const ut=[{value:5,label:"A",color:"#5D87FF"},{value:10,label:"B",color:"#0074BA"},{value:15,label:"C",color:"#01C0C8"},{value:20,label:"D",color:"#CCDA4E"}],ht={width:400,height:200},mt=_("text")(({theme:e})=>({fill:e.palette.text.primary,textAnchor:"middle",dominantBaseline:"central",fontSize:20}));function pt({children:e}){const{width:a,height:i,left:r,top:o}=ge();return t.jsx(mt,{x:r+a/2,y:o+i/2,children:e})}function gt(){return t.jsx(w,{title:"CenterLabel Chart",codeModel:t.jsx(ct,{}),children:t.jsx(S,{series:[{data:ut,innerRadius:80}],...ht,children:t.jsx(pt,{children:"Center label"})})})}function Ct(){return t.jsx(k,{children:`
import * as React from 'react';
import { PieChart } from '@mui/x-charts/PieChart';
...
`).map(a=>`  ${a}`).join(`
`);function xt(){const[e,a]=M.useState(null),[i,r]=M.useState(void 0),o=(l,n,s)=>{r(s.id),a(n)};return t.jsx(w,{title:"OnSeriesItemClick Chart",codeModel:t.jsx(Ct,{}),children:t.jsxs(Q,{direction:{xs:"column",md:"row"},alignItems:{xs:"flex-start",md:"center"},justifyContent:"space-between",sx:{width:"100%"},children:[t.jsx(de,{component:"pre",sx:{maxWidth:{xs:"100%",md:"50%",flexShrink:1},overflow:"auto"},children:`item id: ${i??"undefined"}

                   item identifier:
                   ${At(e)}`}),t.jsx(S,{series:[{data:bt}],onItemClick:o,width:400,height:200,margin:{right:200}})]})})}const ft=[{to:"/",title:"Home"},{title:"PieCharts"}],ga=()=>t.jsxs(ne,{title:"PieCharts",description:"this is PieCharts ",children:[t.jsx(le,{title:"PieCharts",items:ft}),t.jsxs(G,{container:!0,spacing:3,children:[t.jsx(G,{size:{md:6},children:t.jsx(Xe,{})}),t.jsx(G,{size:{md:6},children:t.jsx(Ye,{})}),t.jsx(G,{size:{md:6},children:t.jsx(qe,{})}),t.jsx(G,{size:{md:6},children:t.jsx(at,{})}),t.jsx(G,{size:{md:6},children:t.jsx(nt,{})}),t.jsx(G,{size:{md:6},children:t.jsx(gt,{})}),t.jsx(G,{size:{md:6},children:t.jsx(dt,{})}),t.jsx(G,{size:{md:6},children:t.jsx(xt,{})})]})]});export{ga as default};
