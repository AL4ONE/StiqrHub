...
export default function BasicPieChart() {
  ...
  `})}function Xe(){const e=se(),a=e.palette.primary.main,i=e.palette.secondary.main,r=e.palette.error.main;return t.jsx(w,{title:"Basic Chart",codeModel:t.jsx(Je,{}),children:t.jsx(S,{series:[{data:[{id:0,value:10,label:"series A",color:a},{id:1,value:15,label:"series B",color:i},{id:2,value:20,label:"series C",color:r}]}],height:300})})}function Ye(){return t.jsx(k,{children:`
...
`);function xt(){const[e,a]=M.useState(null),[i,r]=M.useState(void 0),o=(l,n,s)=>{r(s.id),a(n)};return t.jsx(w,{title:"OnSeriesItemClick Chart",codeModel:t.jsx(Ct,{}),children:t.jsxs(Z,{direction:{xs:"column",md:"row"},alignItems:{xs:"flex-start",md:"center"},justifyContent:"space-between",sx:{width:"100%"},children:[t.jsx(ce,{component:"pre",sx:{maxWidth:{xs:"100%",md:"50%",flexShrink:1},overflow:"auto"},children:`item id: ${i??"undefined"}
                   ...
                   item identifier:
                   ${At(e)}`}),t.jsx(S,{series:[{data:bt}],onItemClick:o,width:400,height:200,margin:{right:200}})]})})}const ft=[{to:"/",title:"Home"},{title:"PieCharts"}],pa=()=>t.jsxs(ne,{title:"PieCharts",description:"this is PieCharts ",children:[t.jsx(le,{title:"PieCharts",items:ft}),t.jsxs(G,{container:!0,spacing:3,children:[t.jsx(G,{size:{md:6},children:t.jsx(Xe,{})}),t.jsx(G,{size:{md:6},children:t.jsx(Ke,{})}),t.jsx(G,{size:{md:6},children:t.jsx(Qe,{})}),t.jsx(G,{size:{md:6},children:t.jsx(at,{})}),t.jsx(G,{size:{md:6},children:t.jsx(nt,{})}),t.jsx(G,{size:{md:6},children:t.jsx(gt,{})}),t.jsx(G,{size:{md:6},children:t.jsx(dt,{})}),t.jsx(G,{size:{md:6},children:t.jsx(xt,{})})]})]});export{pa as default};
